...
5. Create Certificate and upload to IAM Certificate Manager or ACM then copy the ARN into the .tfvars
...
- `self_signed_certificate_arn` - Arn for HTTPS Certificate
